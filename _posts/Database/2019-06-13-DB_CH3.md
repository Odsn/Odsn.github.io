...
맨 마지막 tuple이 a,b,c,d가 되었다는 것은 이 decomposition of relation이 lossless join을 갖고 있음을 의미. test 종료! Since there is an unsubscripted row, the decomposition for R is losslsss join 
